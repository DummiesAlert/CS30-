...
when one class inherits another attributes. (In simple terms, a has-a relationship is a class that contains a class member variable within the class 
...
methods cannot be inherited in any sort or form but can be implemented by an infinite amount of classes. 
...
e) The doThis() implementation in “Roo” overrides the doThis() in “Bo”. Moreover it can confuse the code and be mistaken for another method in the class. 
